...
//            $(this).parents('tr')[checked ? 'addClass' : 'removeClass']('selected');
    ...
    BootstrapTable.prototype.ref_options = function (new_options) {
        console.log('---start ref_options---');
        console.log(new_options);
        console.log('---end ref_options---');
        console.log('---start ref_options---');
        console.log(this.options);
        console.log('---end ref_options---');
        for(name in new_options){
            this.options.name=new_options[name];
        }
        console.log('---ref_options---');
        console.log(this.options);
        console.log('---end ref_options---');
    }
    BootstrapTable.prototype.refresh = function (new_opt) {
        if (typeof new_opt != 'undefined')
        {
            for(name in new_opt){
                this.options[name]=new_opt[name];
            }
        }
