...
db_query('ALTER TABLE `' . SPECIAL_OFFERS_TABLE . '` ADD CONSTRAINT `special_productID` FOREIGN KEY (`productID`) REFERENCES `' . PRODUCTS_TABLE . '` (`productID`) ON DELETE CASCADE ON UPDATE CASCADE;');
